                            ...
                            <tr>
                                ...
                                <td>
                                    <audio controls onplay="pauseOthers(this);">
                                        <source src="/audio/{{$ringtone->file}}" type="audio/ogg"> Your browser does not support this element
                                    </audio>
                                </td>
                                ...
                                <td>
                                    <form action="{{route('ringtones.destroy',[$ringtone->id])}}" method="post" onSubmit="return confirm('Do you want to delete this ringtone?')">@csrf
                                        {{method_field('DELETE')}}
